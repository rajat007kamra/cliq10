...
public class AsOfVersionTest extends Base {
	@Test
	public void asOfVersionTest() throws InterruptedException {
		...
		AsOfVersions asVersion = new AsOfVersions(Driver.getDriver(), "");
		asVersion.execute();
		asVersion.validate();
	}
}