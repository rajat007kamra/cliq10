...
public class ForgotPasswordHelper {
	...
	public void handelVerificationPopUp() {
		...
		PageHelper.sendKeys(this.driver, answerElem, securityAnswer);
		PageHelper.click(this.driver, sendButtonElem);
	}
	...
	private String getSecurityAnswer() {
		...
		String securityQuestion = PageHelper.getText(this.driver, questionElem);
